...
# the below is the adapted from train_bpr_baseline.py
...
def train_unify_mi(sens_enc, inter_enc, club, dataset, u_sens,
    ...
    for epoch in range(args.num_epochs):
        ...
        for uij in train_loader:
            ...
            bpr_loss, emb_loss = calc_bpr_loss_here(main_user_emb, main_item_emb, u, i, j)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_path', type=str, default='logs/bpr_fairmi_electronics.txt')
    parser.add_argument('--param_path', type=str, default='param/bpr_fairmi_electronics.pth')
    parser.add_argument('--pretrain_path', type=str, default='param/bpr_base_electronics.pth')
