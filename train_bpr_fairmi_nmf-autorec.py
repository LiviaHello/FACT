...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='ml_bpr_fairmi_nmf-autorec',
    ...
    parser.add_argument('--log_path', type=str, default='logs/bpr_fairmi_nmf-autorec.txt')
    parser.add_argument('--param_path', type=str, default='param/bpr_fairmi_nmf-autorec.pth')
