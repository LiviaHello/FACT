...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_path', type=str, default='logs/bpr_fairmi_nolowbound.txt')
    parser.add_argument('--param_path', type=str, default='param/bpr_fairmi_nolowbound.pth')
