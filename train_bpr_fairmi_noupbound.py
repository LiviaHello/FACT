...
# remove everything that has to do with upper bound
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_path', type=str, default='logs/bpr_fairmi_noupbound.txt')
    parser.add_argument('--param_path', type=str, default='param/bpr_fairmi_noupbound.pth')
