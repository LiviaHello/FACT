...
# the below is the adapted from train_gcn_baseline.py
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_path', type=str, default='logs/gcn_base_electronics.txt')
    parser.add_argument('--param_path', type=str, default='param/gcn_base_electronics.pth')
    parser.add_argument('--num_epochs', type=int, default=250) # we shortened the number of epochs due to computational cost
