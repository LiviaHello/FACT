...
Due to time and computational constraints we were unable to test the following 
code; however, this is how we would personally modify the code below to run with
the pickle file from the electronics dataset
"""
import argparse
...
# the below is the adapted from train_gcn_fairmi.py
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_path', type=str, default='logs/gcn_fairmi_electronics.txt')
    parser.add_argument('--param_path', type=str, default='param/gcn_fairmi_electronics.pth')
    parser.add_argument('--pretrain_path', type=str, default='param/gcn_base_electronics.pth')
    ...
    parser.add_argument('--num_epochs', type=int, default=250) # shortened due to computational cost
