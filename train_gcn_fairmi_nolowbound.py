...
def train_unify_mi(sens_enc, inter_enc, club, dataset, u_sens,
    ...
    for epoch in range(args.num_epochs):
        ...
        for uij in train_loader:
            ...
            up = args.ureg * up
            loss = bpr_loss + emb_loss + up # lb + up
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_path', type=str, default='logs/gcn_fairmi_nolowbound.txt')
    parser.add_argument('--param_path', type=str, default='param/gcn_fairmi_nolowbound.pth')
