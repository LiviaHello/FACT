...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_path', type=str, default='logs/gcn_fairmi_noupbound.txt')
    parser.add_argument('--param_path', type=str, default='param/gcn_fairmi_noupbound.pth')
